function OrderCard() {
  return (
    <>
      <div className="rounded-xl p-4 bg-gray-100 font-SFProDisplay">
        ...
        <div className="pt-3 flex">
            ...
            <div className="pl-3">
             <div className="pb-2 text-sm font-semibold font-unbounded">G’ijduvon shashlik Ajoyib shashlik</div>
             <div className="text-xs text-gray-400 font-medium">56 000 uzs</div>
